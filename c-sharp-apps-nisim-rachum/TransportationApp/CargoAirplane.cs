...
{
    public class CargoAirplane : CargoVehicle
    {
        //private List<Container> containers;

        CargoType cargoType = CargoType.CargoAirplane;

        public CargoAirplane(Driver driver, double maxWeight, double maxVolume, Port currentPort, Port nextPort, int distanceToNextPort)
        {
            Driver = driver;
            MaxWeight = maxWeight;
            MaxVolume = maxVolume;
